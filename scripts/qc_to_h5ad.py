...
def main(mtx_file, genes_file, barcodes_file, output_h5ad):
    # Load configuration
    config = load_config()
    
    print(f"Reading 10x matrix from {mtx_file}")
    ...
    # QC filtering with config parameters
    ...
    adata = adata[adata.obs.pct_counts_mt < config['qc']['pct_mt_max'], :]
